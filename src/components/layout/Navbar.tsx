...
const FEATURED_SERVICES = [
  ...
  },
  {
    ...
    icon: Lightbulb,
    description: 'Brand integrity in a world demanding disruption',
    badge: 'Featured',
  },
];
...
const OTHER_SERVICES = [
  ...
  { name: 'Brand & Visual Identity',  slug: '/services/brand-strategy',           icon: Lightbulb },
...
const MOBILE_ALL_LINKS = [
  ...
  { label: 'Photography', to: '/services/photography',                            group: 'services' },
  { label: 'Brand & Visual Identity', to: '/services/brand-strategy',            group: 'services' },
