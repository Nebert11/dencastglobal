...
const PROJECTS: Record<string, ProjectData> = {
  ...
  'sasini-sustainability-report': {
    ...
    videos: [
      ...
      { title: 'Sasini PLC: A Kenyan Business Feeding the World', url: 'https://www.youtube.com/watch?v=zeLCnl_wASw' },
      { title: 'Sasini PLC Sustainability Documentary (2021)', url: 'https://www.youtube.com/watch?v=2HF4pXkmntk' },
    ],
  ...
  'elf-africa': {
    ...
    videos: [
      { title: 'What Leadership Looked Like in 2025 | ELF-Africa Annual Report', url: 'https://www.youtube.com/watch?v=EgTs8_Bm_RQ' },
      { title: '10 Years of Resilience, Impact, and Growth', url: 'https://www.youtube.com/watch?v=JDr9mvraBjM' },
      { title: "Buzz Women Inspiration Fellowship", url: 'https://www.youtube.com/watch?v=oG_IAvExIqM' },
  ...
  'european-union-videos': {
    ...
    videos: [
      { title: "Kenya's Green Hydrogen Strategy launch", url: 'https://www.youtube.com/watch?v=jIVbFh117dA' },
      { title: 'Global Gateway - Green Energy', url: 'https://www.youtube.com/watch?v=JKVNraadnmw' },
      { title: 'Global Gateway Overview', url: 'https://www.youtube.com/watch?v=nhfmECVhyRg' },
      { title: 'Welcome to our second EU-Kenya Business Forum', url: 'https://www.youtube.com/watch?v=p2ydGxuTK5U' },
    ],
  ...
  'europe-day-football': {
    ...
    videos: [
      { title: 'Europe Day Kenya Marsabit County Preliminaries Overview', url: 'https://www.youtube.com/watch?v=YGQ0MSiaEXs' },
      { title: 'Europe Day Kenya Football Tournament, H.E Gladys Wanga', url: 'https://www.youtube.com/watch?v=nQcN6uXbDss' },
      { title: 'Nairobi County welcome message - Europe Day', url: 'https://www.youtube.com/watch?v=XAZXVI6bvOo' },
    ],
  ...
  'european-investment-bank': {
    ...
    videos: [
      { title: 'Boost Africa Initiative supporting entrepreneurs in Kenya', url: 'https://www.youtube.com/watch?v=632y28-SHt8' },
      { title: 'Shamba Pride: How Venture Capital is Revolutionizing Kenyan Agribusiness', url: 'https://www.youtube.com/watch?v=PxF-Oz5O2xg' },
      { title: 'Bridging the Digital Divide: How Poa Internet Connects Underserved Communities', url: 'https://www.youtube.com/watch?v=mblSEtbtGD8' },
    ],
  ...
  'rhnk-conference': {
    ...
    videos: [
      ...
      { title: 'Youth -Led Systems Change | RHNK Pan African Conference 2026', url: 'https://www.youtube.com/watch?v=QPwGbAjNSpc' },
      { title: 'RHNK Pan-African Conference 2025 Highlights', url: 'https://www.youtube.com/watch?v=_0hFwZtRoqU' },
      { title: 'Youth Caravan & Chini ya Mnazi V2 Highlights | RHNKPanAfricanConference2026', url: 'https://www.youtube.com/watch?v=kIpukvtuV48' },
    ],
  ...
  'live-streaming': {
    ...
    videos: [
      { title: 'Greening The Future One Tree at a Time', url: 'https://www.youtube.com/watch?v=F0sANQiiRxE' },
      { title: 'Tunaweza Project Report Launch', url: 'https://www.youtube.com/watch?v=82Ex2fbk96o' },
      { title: 'RHNK Pan-African CConference | Opening Ceremony Livestream', url: 'https://www.youtube.com/watch?v=Mx4MYVYGcnE' },
      { title: '22nd Annual AGM 2026', url: 'https://www.youtube.com/watch?v=Q7H3QgmaKp8' },
      { title: "6TH National ECD Stakeholder's Conference - Strategy, Commitment and Closure", url: 'https://www.youtube.com/watch?v=eVXun6P1x98' },
      { title: 'Empowering Women & Men Through Childcare Support System', url: 'https://www.youtube.com/watch?v=aMxamcefU8Y' },
      { title: "6TH National ECD Stakeholder's Conference", url: 'https://www.youtube.com/watch?v=ueiIbj_OiV8' },
    ],
  ...
  'documentaries': {
    ...
    videos: [
      { title: 'Sasini PLC Sustainability Documentary 2023', url: 'https://www.youtube.com/watch?v=WDHIUaR6i-c' },
      { title: 'Our Genesis. Our Heritage. Our Aspiration.', url: 'https://www.youtube.com/watch?v=ZBoB9kyjIw4' },
      { title: 'Buzz Women Inspiration Fellowship', url: 'https://www.youtube.com/watch?v=oG_IAvExIqM' },
      { title: 'Tunaweza Impact Documentary.', url: 'https://www.youtube.com/watch?v=IybO1Rr95ek' },
      { title: 'Shaping Young Leaders through the Bible', url: 'https://www.youtube.com/watch?v=NgUnE8g_z6I' },
      { title: 'Catalysing Leaders Graduation', url: 'https://www.youtube.com/watch?v=_3NKliaLP-c' },
      { title: 'RHNK PanAfrican Conference 2026 | Opening Ceremony Highlights', url: 'https://www.youtube.com/watch?v=q-I1iYGhLPk' },
    ],
      ...
      {project.videos.length > 0 && (
        <section className="py-20 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className={`grid gap-6 ${project.videos.length === 1 ? 'grid-cols-1' : 'sm:grid-cols-2'}`}>
